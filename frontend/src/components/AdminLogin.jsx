...
const AdminLogin = () => {
    ...
    try {
        ...
        if (auth.token) {
            ...
            // --- FIX: Save Admin Username to Local Storage ---
            // This ensures the dashboard knows the ADMIN'S name, not the public user's name
            ...
            setTimeout(() => {
                ...
                localStorage.removeItem("username"); // Clean up name on expire
        ...
        <div className='w-full max-w-sm mx-auto bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4'>
            ...
            <form action="" onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className='w-full'>
                    <button className='bg-blue-500 w-full hover:bg-blue-800 text-white font-bold py-2 px-8 rounded focus:outline-none'>
                    Login
                    </button>
                </div>
            </form>
